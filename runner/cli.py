...
def _build_parser() -> argparse.ArgumentParser:
    ...
    run_parser.add_argument("--model", default="claude-sonnet-4-20250514", help="Model identifier")
    run_parser.add_argument("--provider", default="anthropic", help="API provider")
...
def main() -> None:
    ...
    if args.command == "run":
        ...
        print(f"Log:    runs/{log.run_id}.json")
        print(f"{'='*50}")
